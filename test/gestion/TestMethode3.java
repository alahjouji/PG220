...
//classe pour tester la methode3 genere pour chaque fournisseur le fichier xml et svg de simulation selon 
//la methode3
public class TestMethode3 {
	public static void main(String[] args) {
		try{
			...
			for(ElementLecture e:fournisseurs){
			    ...
			    ArrayList<Decoupe> decoupes=Methode3.decouper(commandes2, f);
			    ...
			    XML.writeXML(planches, decoupes, rejet, f, 3, f.getPrix()*planches.size());
			    System.out.println("les fichiers de simulation qui correspondent au fournisseur "
					    +f.getId()+" selon la methode3 sont generes dans le dossier generated qui se trouve " +
					    "dans le dossier bin");
			}
