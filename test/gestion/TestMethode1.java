...
//classe pour tester la methode1 genere pour chaque fournisseur le fichier xml et svg de simulation selon 
//la methode1
	...
	public static void main(String[] args) {
		try{
			...
			for(ElementLecture e:fournisseurs){
			    ...
			    ArrayList<Decoupe> decoupes=Methode1.decouper(commandes2, f);
			    ...
			    XML.writeXML(planches, decoupes, rejet, f, 1, f.getPrix()*planches.size());
			    System.out.println("les fichiers de simulation qui correspondent au fournisseur "
					    +f.getId()+" selon la methode1 sont generes dans le dossier generated qui se trouve " +
					    "dans le dossier bin");
			}
